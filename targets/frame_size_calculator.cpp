...
void til::frame_size_calculator::do_unary_plus_node(cdk::unary_plus_node*, int) {
  // EMPTY
}
void til::frame_size_calculator::do_program_node(til::program_node*, int) {
  // EMPTY
}
...
void til::frame_size_calculator::do_indexptr_node(til::indexptr_node * const node, int lvl) {
  // EMPTY
}
